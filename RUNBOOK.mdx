...
<Command id="publish-helm-scaffold-notes" command='cd "$REPO_FILES" && git checkout -- README.md && mkdir -p docs && cp scaffolds/helm/README.md docs/HELM-SCAFFOLD.md && rm -rf scaffolds/helm scaffolds/terraform-module' />
...
<Command id="publish-terraform-scaffold-notes" command='cd "$REPO_FILES" && git checkout -- README.md && mkdir -p docs && cp scaffolds/terraform-module/README.md docs/TERRAFORM-MODULE-SCAFFOLD.md && rm -rf scaffolds/helm scaffolds/terraform-module' />
